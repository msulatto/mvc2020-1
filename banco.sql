...
-- Copiando estrutura do banco de dados para db3venda1
DROP DATABASE IF EXISTS `db3venda1`;
CREATE DATABASE IF NOT EXISTS `db3venda1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db3venda1`;

-- Copiando estrutura para procedure db3venda1.sp_d_categoria
DROP PROCEDURE IF EXISTS `sp_d_categoria`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_d_pessoa
DROP PROCEDURE IF EXISTS `sp_d_pessoa`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_d_produto
DROP PROCEDURE IF EXISTS `sp_d_produto`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_i_categoria
...
-- Copiando estrutura para procedure db3venda1.sp_i_pessoa
DROP PROCEDURE IF EXISTS `sp_i_pessoa`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_i_produto
DROP PROCEDURE IF EXISTS `sp_i_produto`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_u_categoria
...
-- Copiando estrutura para procedure db3venda1.sp_u_pessoa
DROP PROCEDURE IF EXISTS `sp_u_pessoa`;
DELIMITER //
...
-- Copiando estrutura para procedure db3venda1.sp_u_produto
DROP PROCEDURE IF EXISTS `sp_u_produto`;
DELIMITER //
...
-- Copiando estrutura para tabela db3venda1.tb_categoria
...
-- Copiando dados para a tabela db3venda1.tb_categoria: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela db3venda1.tb_pessoa
...
-- Copiando dados para a tabela db3venda1.tb_pessoa: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela db3venda1.tb_produto
...
-- Copiando dados para a tabela db3venda1.tb_produto: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela db3venda1.tb_track
...
-- Copiando dados para a tabela db3venda1.tb_track: ~0 rows (aproximadamente)
DELETE FROM `tb_track`;
/*!40000 ALTER TABLE `tb_track` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_track` ENABLE KEYS */;

-- Copiando estrutura para tabela db3venda1.tb_venda
...
-- Copiando dados para a tabela db3venda1.tb_venda: ~0 rows (aproximadamente)
DELETE FROM `tb_venda`;
/*!40000 ALTER TABLE `tb_venda` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_venda` ENABLE KEYS */;

-- Copiando estrutura para tabela db3venda1.tb_venda_item
DROP TABLE IF EXISTS `tb_venda_item`;
...
-- Copiando dados para a tabela db3venda1.tb_venda_item: ~0 rows (aproximadamente)
DELETE FROM `tb_venda_item`;
